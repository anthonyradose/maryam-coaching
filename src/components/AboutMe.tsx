    ...
    >
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
          {/* Image */}
          <img
            src="/images/about-me-192.webp"
            srcSet="/images/about-me-192.webp 192w, /images/about-me-224.webp 224w, /images/about-me-384.webp 384w, /images/about-me-448.webp 448w, /images/about-me-576.webp 576w, /images/about-me-672.webp 672w"
          ...
          <div>
            <p className="mb-8 leading-[1.8] tracking-wide text-base md:text-lg">
              ...
              sexuels et émotionnels. Grâce à l’apprentissage d’une
              communication de couple efficace et sereine, qui renforce les
              liens d’amour de manière durable.
            </p>
